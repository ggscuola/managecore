...
<body class="default" alink="white" vlink="white">
    ...
    <div class="corpo" style="height:70%;">
    <br><br><br><br>
    <h3>Aggiorna prodotti.</h3>
        <br>
            <?php
            ...
            $q="select nome_prodotto from magazzino where nome_prodotto='$prodotto'";
            ...
            if($var != 0)
            {
               echo '<div style="color:#CD5C5C;height:5px;">Prodotto già presente</div>'; 
            }
            
            if($var == 0)
            {
                
                $query_mgz="insert into magazzino (nome_prodotto,tipo,quantita)
                values ('$prodotto','$tipo','$quantita')";
                $ris = mysqli_query($conn,$query_mgz);
                
                
                $q="select idm from magazzino where nome_prodotto='$prodotto'";
                ...
                $query_ape="insert into ape (ida,nome_prodotto,tipo,quantita)
                values ('$var','$prodotto','$tipo','0')";
                $ris = mysqli_query($conn,$query_ape);
                
                

                echo '<div style="color:#90EE90;height:5px;">Elemento inserito correttamento</div';
        }
