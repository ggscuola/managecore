...
if($username == "dip")
{
    echo '<div class="utente">Dipendente - Inventario: APE</div>';
}
if($username == "adminu")
{
    echo '<div class="utente">Amministratore - Inventario: APE</div>';
}
if($username == "resp")
{
    echo '<div class="utente">Responsabile - Inventario: APE</div>';
}
...
<body class="default" alink="white" vlink="white">
    ...
    <div class="corpo">
        <?php
            ...
            $query = "select nome_prodotto,tipo,specifica,quantita,day_data,scadenza from ape order by tipo ASC";
