...
<body class="default" alink="white" vlink="white">
    ...
    <h3>Elimina record.</h3>
        ...
        <?php
            ...
            if($var >= 1)
            {
                $query="DELETE FROM magazzino WHERE nome_prodotto = '$prodotto'";
		 $ris=mysqli_query($conn,$query);
                echo '<div style="color:#90EE90;height:5px;">Campo eliminato con successo! </div>';
            }
            if($var == 0)
            {
               // echo "<br><br><br>";
               echo '<div style="color:#CD5C5C;height:5px;">Campo non esistente, Riprova</div>';
            }
            echo "<br><br><br>";
